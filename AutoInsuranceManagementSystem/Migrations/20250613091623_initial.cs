...
namespace AutoInsuranceManagementSystem.Migrations
{
    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PolicyOfferings",
                columns: table => new
                {
                    PolicyOfferingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OfferingName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PolicyOfferings", x => x.PolicyOfferingId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActualCoverageAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    ActualPremiumAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Policies_AspNetUsers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Policies_PolicyOfferings_PolicyOfferingId",
                        column: x => x.PolicyOfferingId,
                        principalTable: "PolicyOfferings",
                        principalColumn: "PolicyOfferingId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhotoProofPath = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                    VideoProofPath = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedPolicyId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SupportTickets_Policies_RelatedPolicyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Policies_PolicyOfferingId",
                table: "Policies",
                column: "PolicyOfferingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupportTickets_RelatedPolicyId",
                table: "SupportTickets",
